      ...
      <Card className="mt-5 bg-dark text-light">
        <Card.Body>
          ...
          <p style={styles.spacing} className=" mt-4 h4 m-4">
            ...
            to fight back. This unknown man, and with the help of Peter, Will,
            and Alvin, decided to fight fire with fire. Thus, project.DOOMBA was
            born. All they needed was one man crazy enough to pilot the monster
            they had created. You are the only person fit to pilot, and the only
            one who can save us from the EDGE.bots. Good luck, and God Speed.
          </p>
        </Card.Body>
      </Card>
      <DummyFooter />
